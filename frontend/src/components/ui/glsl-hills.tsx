...
export const GLSLHills: React.FC<GLSLHillsProps> = ({ 
  width = '100%', 
  height = '100%', 
  cameraZ = 125, 
  planeSize = 256, 
  ...
  useEffect(() => {
    ...
    // Plane class with custom vertex & fragment shaders
    class Plane {
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                vec3 color = vec3(0.38, 0.4, 0.95); // Subtle indigo tint
    ...
    const heightPx = containerRef.current.clientHeight || window.innerHeight;
    const camera = new THREE.PerspectiveCamera(45, widthPx / heightPx, 1, 10000);
